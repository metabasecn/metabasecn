...
export default class QueryHeader extends Component {
    ...
    getHeaderButtons() {
        ...
        if (!isNew) {
            buttonSections.push([
                <Tooltip key="history" tooltip="修改历史">
                    <ModalWithTrigger
                        ref="cardHistory"
        ...
        buttonSections.push([
            <Tooltip key="dataReference" tooltip="查看表结构">
        ...
        return (
            <div className="relative">
                <HeaderBar
                    ...
                    breadcrumb={(!this.props.card.id && this.props.originalCard) ? (<span className="pl2">查询开始于:<a className="link" onClick={this.onFollowBreadcrumb}>{this.props.originalCard.name}</a></span>) : null }
