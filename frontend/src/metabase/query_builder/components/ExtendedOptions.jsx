    ...
    renderSort() {
        ...
        if (tableMetadata) {
            ...
            if ((remainingFieldOptions.count > 0 || remainingExpressions.length > 1) &&
                ...
                addSortButton = (<AddClauseButton text="设置字段排序依据" onClick={() => this.props.addQueryOrderBy([null, "ascending"])} />);
            }
        }
        ...
        return (
            <Popover onClose={() => this.setState({isOpen: false})}>
                <div className="p3">
                    ...
                    { features.limit &&
                        <div>
                            <div className="mb1 h6 text-uppercase text-grey-3 text-bold">查询条数限制</div>
