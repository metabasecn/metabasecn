            ...
            <div className={wrapperClasses}>
                ...
                { isRunning && (
                    <div className="Loading spread flex flex-column layout-centered text-brand z2">
                        <LoadingSpinner />
                        <h2 className="Loading-message text-brand text-uppercase my3">正在计算...</h2>
                    </div>
                )}
...
const VisualizationEmptyState = ({showTutorialLink}) =>
    <div className="flex full layout-centered text-grey-1 flex-column">
        <h1>执行查询，获取数据！</h1>
        { showTutorialLink && <Link to={Urls.question(null, "?tutorial")} className="link cursor-pointer my2">怎样使用?</Link> }
    </div>
