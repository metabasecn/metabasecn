            ...
            <div>
                <form className="Form-new bordered rounded shadowed" onSubmit={this.formSubmitted.bind(this)} noValidate>
                    <FormField fieldName="first_name" formError={formError}>
                        ...
                        <input ref="firstName" className="Form-input Form-offset full" name="name" defaultValue={(user) ? user.first_name : null} placeholder="张" onChange={this.onChange.bind(this)} />
                    ...
                    <FormField fieldName="last_name" formError={formError}>
                        ...
                        <input ref="lastName" className="Form-input Form-offset full" name="name" defaultValue={(user) ? user.last_name : null} placeholder="三" required onChange={this.onChange.bind(this)} />
                        <span className="Form-charm"></span>
                    </FormField>

                    <FormField fieldName="email" formError={formError}>
                        <FormLabel title={ managed ? "用谷歌邮箱登录" : "邮箱地址"} fieldName="email" formError={formError} ></FormLabel>
                        <input
                            ref="email"
                            className={
                              cx("Form-offset full", {
                            ...
                            placeholder="zhangsan@zhangsan.com"
                            required
