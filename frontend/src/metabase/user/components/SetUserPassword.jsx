            ...
            <div>
                <form className="Form-new bordered rounded shadowed" onSubmit={this.formSubmitted.bind(this)} noValidate>
                    <FormField fieldName="old_password" formError={formError}>
                        <FormLabel title="旧密码" fieldName="old_password" formError={formError}></FormLabel>
                    ...
                    <FormField fieldName="password2" formError={formError}>
                        ...
                        <input ref="password2" type="password" className="Form-input Form-offset full" name="password" placeholder="请确保2次输入的密码相同" required onChange={this.onChange.bind(this)} />
                        <span className="Form-charm"></span>
                    </FormField>
