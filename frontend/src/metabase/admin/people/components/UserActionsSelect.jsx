            ...
            <PopoverWithTrigger ref="popover"
                ...
                <ul className="UserActionsSelect">
                    ...
                    { (user.last_login === null && MetabaseSettings.isEmailConfigured()) ?
                        <li className="pt1 pb2 px2 bg-brand-hover text-white-hover cursor-pointer" onClick={this.onResendInvite.bind(this)}>重新发送邀请邮件</li>
                    :
                        <li className="pt1 pb2 px2 bg-brand-hover text-white-hover cursor-pointer" onClick={this.onResetPassword.bind(this)}>重置密码</li>
                    }

                    { !isActiveUser &&
                        <li className="p2 border-top bg-error-hover text-error text-white-hover cursor-pointer"  onClick={this.onRemoveUser.bind(this)}>删除</li>
                    }
                </ul>
            </PopoverWithTrigger>
        );
