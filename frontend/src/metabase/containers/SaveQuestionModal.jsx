...
export default class SaveQuestionModal extends Component {
    ...
    render() {
            ...
            saveOrUpdate = (
                ...
                >
                    <Radio
                        ...
                        options={[
                            { name: `替换源问题, "${this.props.originalCard.name}"`, value: "overwrite" },
                            { name: "另存为新问题", value: "create" },
                        ]}
                        isVertical
                    />
                </FormField>
        ...
        let title = this.props.addToDashboard ? "第一步,保存问题" : "保存问题";
