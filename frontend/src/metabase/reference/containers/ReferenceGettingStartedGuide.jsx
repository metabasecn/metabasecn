...
并告诉你的用户重要的事情
                        ...
                        >
                            <div className="text-measure">
                                ...
                                <textarea
                                    ...
                                    placeholder="例如，对数据隐私和使用的期望，常见的陷阱或误解，有关的信息数据仓库的性能、法律通告等 "
                                    {...things_to_know}
                                />
                            </div>
                        </GuideEditSection>
                        ...
                        <GuideEditSection
                            ...
                            isDisabled={false}
                            collapsedTitle="如果用户对本指南感到困惑，他可以寻求帮助的人？"
                            collapsedIcon="mail"
                            expand={() => {
                    ...
                    <div>
                        ...
                        <div className="wrapper wrapper--trim">
                            { (!guide || isGuideEmpty(guide)) && user && user.is_superuser && (
                                <AdminInstructions>
                                    <h2 className="py2"> 帮助你的团队快速开始数据分析。 </h2>
                                    <GuideText>
                                      通过选择您的顶级仪表板、度量标准和数据来向您的团队展示最重要的部分
                                    </GuideText>
                                    <button
                            ...
                            { Object.keys(metrics).length > 0  && (
                                    <div className="my4 pt4">
                                        ...
                                        { (guide.important_metrics && guide.important_metrics.length > 0) ? [
                                            ...
                                            <GuideText>
                                               度量标准是你们公司关心的重要数字。它们通常是企业表现的核心指标。
                                            </GuideText>
                                        }
                                        <div>
                                ...
                                :
                                    <GuideText>
                                        { Object.keys(segments).length > 0 ? (
                                            <span>
                                              段和表是公司数据的组成部分。表是原始信息的集合，而片段是具有特定含义的特定切片。, 例如 <b>"最近的订单."</b>
                                            </span>
                                        ) : "表是公司数据的组成部分。 ."
                                        }
                                    </GuideText>
                            ...
                            <div className="mt4 pt4">
                                <SectionHeader trim={!guide.things_to_know}>
                                    { guide.things_to_know ? '关于我们的数据要知道的其他东西' : '寻找更多' }
                                </SectionHeader>
                                <GuideText>
                                    { guide.things_to_know ? guide.things_to_know : "了解数据的一个好方法是花一些时间探索不同的表格和其他信息。这可能需要一段时间，但随着时间的推移，你将开始认识名字和意义。 ."
                                    }
                                </GuideText>
