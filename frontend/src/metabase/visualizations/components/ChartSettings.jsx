            ...
            <div className="flex flex-column spread p4">
                ...
                <div className="pt1">
                  ...
                  { !_.isEqual(this.state.settings, {}) &&
                      <a className="Button Button--warning float-right" onClick={this.onResetSettings} data-metabase-event="Chart Settings;Reset">重置为默认图表</a>
                  }
                </div>
            </div>
        );
