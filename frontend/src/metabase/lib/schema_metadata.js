...
var Aggregators = [{
    name: "表格行数据",
    short: "rows",
    description: "只有一个表中行的答案，没有额外的操作。.",
    validFieldsFilters: [],
    requiresField: false,
    ...
    name: "标准差 ...",
    short: "stddev",
    description: "表示列的值在应答中所有行之间变化的数量。.",
    validFieldsFilters: [summableFields],
    requiresField: true,
